...
export const locations: Location[] = [
  {
    ...
    professionals: [
      "dra-ejemplo-mastologa",
      "dr-ejemplo-cirujano",
      "dra-ejemplo-oncologa",
      "lic-ejemplo-psicooncologia",
      "dra-ejemplo-plastica",
    ],
    ...
    accessibility:
      "[Información de accesibilidad – pendiente de confirmación]",
    directions:
  ...
  },
  {
    ...
    address: "Calle 474 Nº 583, City Bell",
    city: "City Bell",
    description:
