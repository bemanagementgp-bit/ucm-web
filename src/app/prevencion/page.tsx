...
export const metadata: Metadata = {
  title: "Prevención",
  description:
    "Información general sobre prevención y cuidado mamario: controles periódicos, autoobservación, cuándo consultar y estudios habituales. Contenido educativo que no reemplaza la consulta médica.",
};
    ...
    <>
      ...
      <section className="pt-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <MedicalDisclaimer text="La información de esta página tiene fines educativos y de concientización. No constituye un diagnóstico ni una indicación médica personalizada. Ante cualquier duda, consultá con un profesional de UCM." />
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            tag="Ejes de la prevención"
            title="Cuidar tu salud mamaria, un hábito a la vez"
            description="La prevención combina distintos hábitos y controles a lo largo de la vida. Estos son los ejes principales."
          />
      ...
      {articles.length > 0 && (
        <section className="py-16 md:py-20 bg-primary-lightest/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <SectionHeading
              tag="Para seguir leyendo"
              title="Artículos relacionados"
              description="Más información sobre prevención y cuidado de la salud mamaria."
            />
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
